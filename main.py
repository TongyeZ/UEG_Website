...
# # Read the CSV file
# ueg_data = pd.read_csv('/Users/sophiazhang/Desktop/UbiquitouslyExpressedGenes/data/Table 7. The global expression specificity and global expression patterns of human genes.csv')
